...
import com.samjay.payment_service.enumerations.IdempotencyStatus;
...
import static com.samjay.payment_service.utility.AppExtensions.deserialize;
import static com.samjay.payment_service.utility.AppExtensions.serialize;
...
public class IdempotencyServiceImplementation implements IdempotencyService {
    ...
    @Override
    public int saveKey(String idempotencyKey, String eventType, String fingerprint) {

        return idempotencyRecordRepository.insertIgnoreConflict(idempotencyKey, eventType, fingerprint, LocalDateTime.now(),
