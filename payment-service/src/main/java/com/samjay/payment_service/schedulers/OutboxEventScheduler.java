...
import com.samjay.payment_service.entities.OutboxEvent;
import com.samjay.payment_service.enumerations.OutboxEventStatus;
import com.samjay.payment_service.repositories.OutboxEventRepository;
    ...
    private void publishEvent(OutboxEvent event) {
        ...
        try {
            ...
            var message = MessageBuilder
                    .withPayload(Objects.requireNonNull(payload))
